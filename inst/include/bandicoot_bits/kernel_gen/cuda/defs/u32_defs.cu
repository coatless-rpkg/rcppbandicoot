...
__device__ inline uint coot_to_uint(const  cx_float& x) { return (uint) x.x; }
__device__ inline uint coot_to_uint(const cx_double& x) { return (uint) x.x; }

// Utility mathematical functions.
__device__ inline uint coot_absdiff(const uint x, const uint y) { return (x > y) ? (x - y) : (y - x); }
__device__ inline uint coot_min(const uint x, const uint y) { return min(x, y); }
__device__ inline uint coot_max(const uint x, const uint y) { return max(x, y); }
__device__ inline uint coot_conj(const uint x) { return x; }
__device__ inline uint coot_abs(const uint x) { return x; }
__device__ inline uint coot_sign(const uint x) { return (x > 0) ? 1 : 0; }

// Basic mathematical operators.
__device__ inline uint coot_plus(const uint x, const uint y)  { return x + y; }
__device__ inline uint coot_minus(const uint x, const uint y) { return x - y; }
__device__ inline uint coot_times(const uint x, const uint y) { return x * y; }
__device__ inline uint coot_div(const uint x, const uint y)   { return x / y; }
