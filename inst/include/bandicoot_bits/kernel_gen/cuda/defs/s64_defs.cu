...
__device__ inline long coot_min(const long x, const long y) { return min(x, y); }
...
__device__ inline long coot_minus(const long x, const long y) { return x - y; }
__device__ inline long coot_times(const long x, const long y) { return x * y; }
__device__ inline long coot_div(const long x, const long y)   { return x / y; }
