...
__device__ inline __half coot_min(const __half x, const __half y) { return __hmin(x, y); }
...
__device__ inline __half coot_minus(const __half x, const __half y) { return x - y; }
__device__ inline __half coot_times(const __half x, const __half y) { return x * y; }
__device__ inline __half coot_div(const __half x, const __half y)   { return x / y; }
