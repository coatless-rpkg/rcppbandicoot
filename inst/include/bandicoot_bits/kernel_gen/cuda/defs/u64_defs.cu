...
__device__ inline size_t coot_to_size_t(const  cx_float& x) { return (size_t) x.x; }
__device__ inline size_t coot_to_size_t(const cx_double& x) { return (size_t) x.x; }

// Utility mathematical functions.
__device__ inline size_t coot_absdiff(const size_t x, const size_t y) { return (x > y) ? (x - y) : (y - x); }
__device__ inline size_t coot_min(const size_t x, const size_t y) { return min(x, y); }
__device__ inline size_t coot_max(const size_t x, const size_t y) { return max(x, y); }
__device__ inline size_t coot_conj(const size_t x) { return x; }
__device__ inline size_t coot_abs(const size_t x) { return x; }
__device__ inline size_t coot_sign(const size_t x) { return (x > 0) ? 1 : 0; }

// Basic mathematical operators.
__device__ inline size_t coot_plus(const size_t x, const size_t y)  { return x + y; }
__device__ inline size_t coot_minus(const size_t x, const size_t y) { return x - y; }
__device__ inline size_t coot_times(const size_t x, const size_t y) { return x * y; }
__device__ inline size_t coot_div(const size_t x, const size_t y)   { return x / y; }
