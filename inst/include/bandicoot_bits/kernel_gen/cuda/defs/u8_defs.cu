...
__device__ inline uchar coot_min(const uchar x, const uchar y) { return min(x, y); }
...
__device__ inline uchar coot_minus(const uchar x, const uchar y) { return x - y; }
__device__ inline uchar coot_times(const uchar x, const uchar y) { return x * y; }
__device__ inline uchar coot_div(const uchar x, const uchar y)   { return x / y; }
