...
__device__ inline short coot_to_short(const  cx_float& x) { return (short) x.x; }
__device__ inline short coot_to_short(const cx_double& x) { return (short) x.x; }

// Utility mathematical functions.
__device__ inline short coot_absdiff(const short x, const short y) { return abs(x - y); }
__device__ inline short coot_min(const short x, const short y) { return min(x, y); }
__device__ inline short coot_max(const short x, const short y) { return max(x, y); }
__device__ inline short coot_conj(const short x) { return x; }
__device__ inline short coot_abs(const short x) { return abs(x); }
__device__ inline short coot_sign(const short x) { return (x > 0) ? 1 : (x == 0) ? 0 : -1; }

// Basic mathematical operators.
__device__ inline short coot_plus(const short x, const short y)  { return x + y; }
__device__ inline short coot_minus(const short x, const short y) { return x - y; }
__device__ inline short coot_times(const short x, const short y) { return x * y; }
__device__ inline short coot_div(const short x, const short y)   { return x / y; }
