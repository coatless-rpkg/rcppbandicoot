...
inline uchar coot_type_min_uchar(const uchar x)    { return 0; }
inline uchar coot_type_minpos_uchar(const uchar x) { return 1; }
inline uchar coot_type_max_uchar(const uchar x)    { return COOT_U8_MAX; }
...
inline uchar coot_minus_uchar(const uchar x, const uchar y) { return x - y; }
inline uchar coot_times_uchar(const uchar x, const uchar y) { return x * y; }
inline uchar coot_div_uchar(const uchar x, const uchar y)   { return x / y; }
