...
#endif
#ifndef CL_HALF_MANT_DIG
#define COOT_UNDEF_CL_HALF_MANT_DIG
#define CL_HALF_MANT_DIG 11
#endif
#ifndef CL_HALF_MAX_EXP
#define COOT_UNDEF_CL_HALF_MAX_EXP
#define CL_HALF_MAX_EXP +16
#endif
#ifndef CL_HALF_MIN_EXP
#define COOT_UNDEF_CL_HALF_MIN_EXP
#define CL_HALF_MIN_EXP -13
  ...
  inline explicit operator cl_half() const
  {
    ...
    if (exp < (CL_HALF_MIN_EXP - CL_HALF_MANT_DIG - 1))
    {
      ...
      //
      if (rounding_mode == FE_UPWARD && !sign)
      {
...
#endif
#ifndef COOT_UNDEF_CL_HALF_MANT_DIG
#undef COOT_UNDEF_CL_HALF_MANT_DIG
#undef CL_HALF_MANT_DIG
#endif
#ifndef COOT_UNDEF_CL_HALF_MAX_EXP
#undef COOT_UNDEF_CL_HALF_MAX_EXP
#undef CL_HALF_MAX_EXP
#endif
#ifndef COOT_UNDEF_CL_HALF_MIN_EXP
#undef COOT_UNDEF_CL_HALF_MIN_EXP
#undef CL_HALF_MIN_EXP
#endif
#endif
