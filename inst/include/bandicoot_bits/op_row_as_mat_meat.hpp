...
inline
uword
op_row_as_mat::compute_n_rows(const CubeToMatOp<T1, op_row_as_mat>& op, const uword in_n_rows, const uword in_n_cols, const uword in_n_slices)
  {
  coot_ignore(op);
...
inline
uword
op_row_as_mat::compute_n_cols(const CubeToMatOp<T1, op_row_as_mat>& op, const uword in_n_rows, const uword in_n_cols, const uword in_n_slices)
  {
  coot_ignore(op);
  coot_ignore(in_n_rows);
