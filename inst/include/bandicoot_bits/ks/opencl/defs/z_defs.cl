...
inline cx_double coot_type_min_cx_double()    { return (cx_double)(-DBL_MAX, -DBL_MAX); }
inline cx_double coot_type_minpos_cx_double() { return (cx_double)(DBL_MIN, DBL_MIN); }
inline cx_double coot_type_max_cx_double()    { return (cx_double)(DBL_MAX, DBL_MAX); }
...
inline cx_double coot_mul_cx_double(const cx_double x, const cx_double y)   { return (cx_double)( x.x * y.x - x.y * y.y, x.x * y.y + x.y * y.x ); }
inline cx_double coot_div_cx_double(const cx_double x, const cx_double y)   { return (cx_double)( (x.x * y.x + x.y * y.y) / (y.x * y.x + y.y * y.y), (x.y * y.x - x.x * y.y) / (y.x * y.x + y.y * y.y) ); }
