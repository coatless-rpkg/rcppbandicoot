...
__device__
void
COOT_FN(PREFIX,index_min_subgroup_reduce)(volatile eT1* data, volatile UWORD* uword_data, int tid)
  {
...
__global__
void
COOT_FN(PREFIX,index_min)(const eT1* in_mem,
  ...
  if (tid < 32) // unroll last warp's worth of work
    {
    COOT_FN(PREFIX,index_min_subgroup_reduce)(aux_mem, aux_uword_mem, tid);
    }
