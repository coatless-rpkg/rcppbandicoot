...
glue_join_rows::apply(Mat<eT>& out, const T1& A, const T2& B, const T3& C, const std::string& func_name)
  ...
  coot_conform_check( ((A_n_rows != out_n_rows) && ((A_n_rows > 0) || (A_n_cols > 0))), func_name + ": number of rows must be the same" );
  coot_conform_check( ((B_n_rows != out_n_rows) && ((B_n_rows > 0) || (B_n_cols > 0))), func_name + ": number of rows must be the same" );
  coot_conform_check( ((C_n_rows != out_n_rows) && ((C_n_rows > 0) || (C_n_cols > 0))), func_name + ": number of rows must be the same" );
...
glue_join_rows::apply(Mat<eT>& out, const T1& A, const T2& B, const T3& C, const T4& D, const std::string& func_name)
  ...
  coot_conform_check( ((B_n_rows != out_n_rows) && ((B_n_rows > 0) || (B_n_cols > 0))), func_name + ": number of rows must be the same" );
  coot_conform_check( ((C_n_rows != out_n_rows) && ((C_n_rows > 0) || (C_n_cols > 0))), func_name + ": number of rows must be the same" );
  coot_conform_check( ((D_n_rows != out_n_rows) && ((D_n_rows > 0) || (D_n_cols > 0))), func_name + ": number of rows must be the same" );
