...
join_cols(dev_mem_t<eT> out,
  ...
  const size_t out_offset = out_row_offset + out.cl_mem_ptr.offset;
  const size_t A_offset   = A_row_offset + A.cl_mem_ptr.offset;
  const size_t B_offset   = B_row_offset + B.cl_mem_ptr.offset;
