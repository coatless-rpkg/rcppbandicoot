...
index_min(dev_mem_t<uword> dest,
  ...
  coot_check_runtime_error( (get_rt().cl_rt.is_valid() == false), "coot::opencl::index_min(): OpenCL runtime not valid" );
...
index_min_cube_col(dev_mem_t<uword> dest,
  ...
  coot_check_runtime_error( (get_rt().cl_rt.is_valid() == false), "coot::opencl::index_min_cube_col(): OpenCL runtime not valid" );
...
index_min_vec(dev_mem_t<eT> mem, const uword n_elem, eT* min_val)
  ...
  coot_check_runtime_error( (get_rt().cl_rt.is_valid() == false), "coot::opencl::index_min_vec(): OpenCL runtime not valid" );
