...
join_rows(dev_mem_t<eT> out,
  ...
  if (A_n_rows > 0 && A_n_cols > 0)
    ...
    const size_t region[3]     = { sizeof(ceT) * A_n_rows,   A_n_cols,       1 };
    ...
    status = coot_wrapper(clEnqueueCopyBufferRect)(get_rt().cl_rt.get_cq(),
                                                   ...
                                                   out_origin,
                                                   region,
                                                   sizeof(ceT) * A_M_n_rows,
                                                   0,
                                                   sizeof(ceT) * out_M_n_rows,
                                                   0,
                                                   0,
                                                   NULL,
                                                   NULL);
  ...
  if (B_n_rows > 0 && B_n_cols > 0)
    ...
    const size_t out_origin[3] = { sizeof(ceT) * out_offset, A_n_cols + out_col_offset, 0 };
    const size_t region[3]     = { sizeof(ceT) * B_n_rows,   B_n_cols,                  1 };
  ...
  if (C_n_rows > 0 && C_n_cols > 0)
    ...
    const size_t out_origin[3] = { sizeof(ceT) * out_offset, A_n_cols + B_n_cols + out_col_offset, 0 };
    const size_t region[3]     = { sizeof(ceT) * C_n_rows,   C_n_cols,                             1 };
  ...
  if (D_n_rows > 0 && D_n_cols > 0)
    ...
    const size_t out_origin[3] = { sizeof(ceT) * out_offset, A_n_cols + B_n_cols + C_n_cols + out_col_offset, 0 };
    const size_t region[3]     = { sizeof(ceT) * D_n_rows,   D_n_cols,                                        1 };
