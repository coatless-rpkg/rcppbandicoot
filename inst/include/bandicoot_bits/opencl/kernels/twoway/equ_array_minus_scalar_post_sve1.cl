...
__kernel
void
COOT_FN(PREFIX,equ_array_minus_scalar_post_sve1)(__global eT2* dest,
  ...
  if (i < n_elem)
    {
    dest[dest_locs[i + dest_locs_offset] + dest_offset] = ((eT2) (src[src_locs[i + src_locs_offset] + src_offset] - val_pre)) - val_post;
    }
  }
