...
inline
uword
mtop_real::compute_n_rows(const mtOp<out_eT, T1, mtop_real>& op, const uword in_n_rows, const uword in_n_cols)
  {
  coot_ignore(op);
...
inline
uword
mtop_real::compute_n_cols(const mtOp<out_eT, T1, mtop_real>& op, const uword in_n_rows, const uword in_n_cols)
  {
  coot_ignore(op);
