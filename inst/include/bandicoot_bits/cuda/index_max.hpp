...
index_max(dev_mem_t<uword> dest,
  ...
  coot_check_runtime_error( (get_rt().cuda_rt.is_valid() == false), "coot::cuda::index_max(): cuda runtime not valid" );
...
index_max_cube_col(dev_mem_t<uword> dest, const dev_mem_t<eT> src, const uword n_rows, const uword n_cols, const uword n_slices)
  ...
  coot_check_runtime_error( (get_rt().cuda_rt.is_valid() == false), "coot::cuda::index_max_cube_col(): CUDA runtime not valid" );
...
index_max_vec(dev_mem_t<eT> mem, const uword n_elem, eT* max_val)
  ...
  coot_check_runtime_error( (get_rt().cuda_rt.is_valid() == false), "coot::cuda::index_max_vec(): cuda runtime not valid" );
