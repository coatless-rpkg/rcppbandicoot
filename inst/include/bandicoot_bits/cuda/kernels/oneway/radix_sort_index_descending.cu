...
__global__
void
COOT_FN(PREFIX,radix_sort_index_descending)(eT1* A,
                                            UWORD* A_index,
                                            eT1* tmp_mem,
                                            UWORD* tmp_mem_index,
                                            const UWORD n_elem)
  ...
  if (coot_is_fp(TO_ET1(0)))
    ...
    while (i + 1 < end_elem)
      {
      const eT1 val1 = unsorted_memptr[i];
      const eT1 index1 = unsorted_index_memptr[i];
      ...
      const eT1 val2 = unsorted_memptr[i + 1];
      const eT1 index2 = unsorted_index_memptr[i + 1];
    ...
    if (i < end_elem)
      {
      const eT1 val = unsorted_memptr[i];
      const eT1 index = unsorted_index_memptr[i];
