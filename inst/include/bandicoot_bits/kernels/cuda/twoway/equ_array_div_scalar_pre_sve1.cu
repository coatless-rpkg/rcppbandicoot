...
__global__
void
COOT_FN(PREFIX,equ_array_div_scalar_pre_sve1)(eT2* dest,
  ...
  if (i < n_elem)
    ...
    if (val_post == TO_ET2(0))
      {
      dest[dest_locs[i]] = TO_ET2(val_pre / src[src_locs[i]]);
      }
      ...
      dest[dest_locs[i]] = val_post / TO_ET2(val_pre / src[src_locs[i]]);
      }
    }
  }
